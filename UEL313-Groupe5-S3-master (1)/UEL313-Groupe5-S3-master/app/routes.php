...
// Admin zone
$app->match('/admin', "Watson\Controller\AdminController::indexAction")->bind('admin'); //j'ai remplacé get par match prcq match accepte les paramètres GET
...
// RSS road
$app->get('/rss', "Watson\Controller\HomeController::indexActionRss")->bind('rss');